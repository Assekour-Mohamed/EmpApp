...
class clsUpdatEmp:
    def __init__(self, top=None):
        ...
        self.btnUpdateEmployer = tk.Button(self.top)
        self.btnUpdateEmployer.place(relx=0.367, rely=0.889, height=36, width=150)
        self.btnUpdateEmployer.configure(takefocus="")
        self.btnUpdateEmployer.configure(text='''Update EMP''')
        self.btnUpdateEmployer.configure(compound='left')
        self.btnUpdateEmployer.configure(command=self.updateEmployee)
        ...
        self.enPrimeRespo = tk.Entry(self.top,state="normal")
        ...
        self.enMatricule.place(relx=0.3, rely=0.267, relheight=0.064, relwidth=0.207)
        ...
        self.TLabel6.configure(text='''UPDATING EMPLOER WINDOW''')
    ...
    def updateEmployee(self):
        try:
            if self.empType.get() == "agent":
                ...
                newAgent.updateAgentInJSON(self.enMatricule.get())
                ...
                newFormateur.updateFormateurInJSON(self.enMatricule.get()) 
            
            self.top.destroy()
            messagebox.showinfo("update message", "employee updated successfully!")
        except:
            messagebox.showinfo("update message", "employee update failed!! check your input!")
...
#         self.TLabel6 = tk.Label(self.top)
#         self.TLabel6.place(relx=0.233, rely=0.067, height=47, width=353)
#         self.TLabel6.configure(font="-family {Segoe UI} -size 14")
#         self.TLabel6.configure(relief="flat")
#         self.TLabel6.configure(anchor='w')
#         self.TLabel6.configure(justify='center')
#         self.TLabel6.configure(text='''UPDATING EMPLOER WINDOW''')
